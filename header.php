...
<head>
	...
	<style type="text/css">
		#wrapper > .bg { 
			background-image: url("<?php echo get_template_directory_uri() . '/assets/images/overlay.png' ?>"), linear-gradient(0deg, rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.1)), url("<?php echo get_theme_mod( 'massively_wp_background' ); ?>");
		}
	</style>
